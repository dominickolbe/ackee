...
const CardFacts = (props) => {
  ...
  return h(
    ...
    h(Presentation, {
      ...
      addition:
        averageViews.change != null &&
        h(ChangeBadge, { value: averageViews.change }),
    }),
    h(Presentation, {
      headline: "Average duration",
      value: formatDuration(averageDuration.count).value,
      unit: formatDuration(averageDuration.count).unit,
      title: `An average visit duration of ${
        formatDuration(averageDuration.count).value
      }${
        formatDuration(averageDuration.count).unit
      } per day during the last 14 days`,
      addition:
        averageDuration.change != null &&
        h(ChangeBadge, { value: averageDuration.change }),
    }),
    h(Presentation, {
