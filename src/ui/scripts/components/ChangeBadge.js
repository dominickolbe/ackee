...
const title = (value, formattedValue) => {
  if (value > 0)
    return `A ${formattedValue} increase when comparing the last 7 days with the previous 7 days`;
  if (value < 0)
    return `A ${formattedValue} decrease when comparing the last 7 days with the previous 7 days`;
