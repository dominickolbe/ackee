...
const calculateX = (measurement) => {
  ...
  return Math.max(
    ...
    Math.min(
      ...
      measurement.target.relative.x +
        measurement.target.width / 2 -
        measurement.element.width / 2,
    ),
  );
};
...
const Filter = (props) => {
  const sortingButtons = [
    createButton(
      "Top",
      "Top entries first",
      props.setSortingFilter,
      props.filters.sorting,
      sortings.SORTINGS_TOP,
    ),
    createButton(
      "New",
      "New entries only",
  ...
  const rangeButtons = [
    createButton(
      "24 hours",
      "Show last 24 hours",
      props.setRangeFilter,
      props.filters.range,
      ranges.RANGES_LAST_24_HOURS,
    ),
    createButton(
      "7 days",
      "Show last 7 days",
  ...
  const intervalsButtons = [
    createButton(
      "Daily",
      "Grouped by day",
      props.setIntervalFilter,
      props.filters.interval,
      intervals.INTERVALS_DAILY,
    ),
    createButton(
      "Monthly",
      "Grouped by month",
    ...
    createButton(
      ...
      props.setIntervalFilter,
      props.filters.interval,
      intervals.INTERVALS_YEARLY,
    ),
  ];

  const sortingItem = createItem(
    labels.sortings[props.filters.sorting],
    sortingButtons,
  );
  const rangeItem = createItem(
    labels.ranges[props.filters.range],
    rangeButtons,
    props.filters.sorting === sortings.SORTINGS_TOP,
  );
  const intervalItem = createItem(
    labels.intervals[props.filters.interval],
    intervalsButtons,
  );
    ...
    [routes.VIEWS]: [
      createItem(labels.views[props.filters.viewsType], [
        createButton(
          "Unique",
          "Unique site views",
          props.setViewsTypeFilter,
          props.filters.viewsType,
          views.VIEWS_TYPE_UNIQUE,
        ),
        createButton(
          "Total",
          "Total page views",
          props.setViewsTypeFilter,
          props.filters.viewsType,
          views.VIEWS_TYPE_TOTAL,
        ),
      ]),
      intervalItem,
    ],
    [routes.PAGES]: [sortingItem, rangeItem],
    [routes.REFERRERS]: [
      sortingItem,
      createItem(labels.referrers[props.filters.referrersType], [
        createButton(
          "Combined",
          "Prefer source parameter",
          props.setReferrersTypeFilter,
          props.filters.referrersType,
          referrers.REFERRERS_TYPE_WITH_SOURCE,
        ),
        createButton(
          "↳ referrers only",
          undefined,
          props.setReferrersTypeFilter,
          props.filters.referrersType,
          referrers.REFERRERS_TYPE_NO_SOURCE,
        ),
        createButton(
          "↳ sources only",
          undefined,
          props.setReferrersTypeFilter,
          props.filters.referrersType,
          referrers.REFERRERS_TYPE_ONLY_SOURCE,
        ),
      ]),
      rangeItem,
    ],
    [routes.DURATIONS]: [intervalItem],
    [routes.EVENTS]: [intervalItem, sortingItem],
    [routes.SYSTEMS]: [
      createItem(labels.sortings[props.filters.sorting], [
        ...
        onlyInactiveButton(
          createButton(
            ...
            props.setSystemsTypeFilter,
            props.filters.systemsType,
            systems.SYSTEMS_TYPE_WITH_VERSION,
          ),
          createButton(
            "Hide version",
            ...
            props.setSystemsTypeFilter,
            props.filters.systemsType,
            systems.SYSTEMS_TYPE_NO_VERSION,
          ),
        ),
      ]),
      rangeItem,
      ...
      createItem(labels.sortings[props.filters.sorting], [
        ...
        onlyInactiveButton(
          createButton(
            ...
            props.setDevicesTypeFilter,
            props.filters.devicesType,
            devices.DEVICES_TYPE_WITH_MODEL,
          ),
          createButton(
            "Hide model",
            "Don't include model",
      ...
      createItem(labels.sortings[props.filters.sorting], [
        ...
        onlyInactiveButton(
          createButton(
            ...
            props.setBrowsersTypeFilter,
            props.filters.browsersType,
            browsers.BROWSERS_TYPE_WITH_VERSION,
          ),
          createButton(
            "Hide version",
            "Don't include version",
            props.setBrowsersTypeFilter,
            props.filters.browsersType,
            browsers.BROWSERS_TYPE_NO_VERSION,
          ),
        ),
      ]),
      rangeItem,
    ...
    [routes.SIZES]: [
      ...
      createItem(labels.sizes[props.filters.sizesType], [
        createButton(
          ...
          props.setSizesTypeFilter,
          props.filters.sizesType,
        ...
        createButton(
          ...
          props.setSizesTypeFilter,
          props.filters.sizesType,
          sizes.SIZES_TYPE_BROWSER_WIDTH,
        ),
        createButton(
          "↳ heights",
          undefined,
          props.setSizesTypeFilter,
          props.filters.sizesType,
          sizes.SIZES_TYPE_BROWSER_HEIGHT,
        ),
        createSeparator(),
        createButton(
          "Screen sizes",
          ...
          props.setSizesTypeFilter,
          props.filters.sizesType,
          sizes.SIZES_TYPE_SCREEN_RESOLUTION,
        ),
        createButton(
          "↳ widths",
          undefined,
        ...
        createButton(
          ...
          props.setSizesTypeFilter,
          props.filters.sizesType,
          sizes.SIZES_TYPE_SCREEN_HEIGHT,
        ),
      ]),
      rangeItem,
    ],
